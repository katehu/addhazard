###July, 2014
### Kate Hu
### calculate complete dataset estimate and its variance 
### Z is p demensional
...
### for  code testing purposes
  ...
  ###############################################################################
  ###   Calculate the  average of Z for patients still at risk at time point t
  ###   we call it eta(t)
  ###   Since this average only changes at the time when a patient fails or is 	   
  ###   cencored. Therefore we only calculate it for each unique.ordered.failure
  
  
  ### We calcuate the numerator and the denomiators of eta separtedly 
