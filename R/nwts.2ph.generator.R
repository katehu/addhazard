...
# create a hypothetical two-phase sampling (stratified sampling) data
# in this dataset, only people who have relapse and some control have 
# their samples sent to the central laboratory for histology determination 
nwts.2ph <- nwtsco

# Institutional histology is examined in local hospital thus 
...
# sent to the central laboratory and the work requires experienced researchers
# thus  it is reasonable to assume only some samples were tested for central 
# histology. Based on the outcomes and institutional histology, we determin who 
